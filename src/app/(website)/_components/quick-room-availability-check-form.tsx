...
const QuickRoomAvailabilityCheckForm = () => {
  ...
  return (
    <div className="flex items-center justify-center lg:-mt-[70px] z-30 relative lg:px-4">
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(onSubmit)}
          className="bg-white px-6 py-10 lg:rounded-lg shadow-md w-full grid gap-6 md:grid-cols-2 lg:grid-cols-5 lg:items-end lg:max-w-7xl"
        >
          <FormField
...
export default QuickRoomAvailabilityCheckForm;
